...
export function PlatformScheduleForm({
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const result = await updatePlatformSettings({ opensAt, closesAt });
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
      ...
      <p className="text-xs text-muted-foreground">
        Este horario aplica a TODA la tienda, encima del horario propio de cada proveedor — si cualquiera
        de los dos está cerrado, el producto muestra &quot;Fuera de horario&quot;. Deja ambos campos vacíos
        para no restringir por plataforma.
      </p>
