...
import { ActivationStatusButtons } from "@/components/proveedores/ActivationStatusButtons";
            ...
            <Card key={s.id} className="flex flex-col gap-3">
              <div className="flex flex-wrap items-start justify-between gap-2">
                <div>
                  ...
                  {s.product.type === "ACTIVACION2" && (
                    <div className="mt-2">
                      <ActivationStatusButtons purchaseId={s.id} status={s.activationStatus} />
                    </div>
                  )}
                </div>
                <div className="flex items-center gap-2">
