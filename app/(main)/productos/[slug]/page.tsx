...
import { isViewerActiveSeller } from "@/lib/actions/pricing";
...
import { CopyProductInfoButton } from "@/components/streaming/CopyProductInfoButton";
      ...
      <div className="grid gap-8 md:grid-cols-2">
        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
            ...
            {isSeller && (
              <CopyProductInfoButton productName={product.name} description={product.description} conditions={product.conditions} />
            )}
          </div>
          {closed && (
